...
import * as Articles from '@/store/articles/type';
...
declare module 'vuex' {
    ...
    type RootGetters = Articles.IRootGetters;

    type RootMutations = Articles.IRootMutations;

    type RootActions = Articles.IActions;
}
